...
export const btnPrimary =
  "cursor-pointer rounded-[7px] bg-accent px-3.5 py-1.5 text-[12.5px] font-semibold text-[#0d0a1f] shadow-[0_0_20px_-4px_rgba(139,124,247,.5)] hover:bg-accent2 disabled:cursor-not-allowed disabled:opacity-50";
